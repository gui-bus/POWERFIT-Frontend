    ...
    <div className="relative w-full">
      <div className="relative group">
        ...
        <input
          ...
          className="w-full bg-card border-2 border-border rounded-[2rem] py-5 pl-14 pr-6 text-sm font-medium focus:outline-hidden focus:border-primary/50 transition-all shadow-sm hover:shadow-md"
        />
      </div>
            ...
            {results.map((user) => (
              ...
              >
                <Link href={`/profile/${user.id}`} className="flex items-center gap-4 flex-1">
                  <Avatar className="size-12 border border-border rounded-xl">
                ...
                <div className="flex items-center gap-2">
                  {!user.isFriend && !user.isPending && (
                    <button
                      ...
                      className="p-3 bg-primary text-primary-foreground rounded-xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-primary/20"
