...
const MOCK_POSTS = [
  ...
  },
  {
    ...
    readTime: "6 min",
    image:
      "https://images.unsplash.com/photo-1541480601022-2308c0f02487?auto=format&fit=crop&q=80&w=400",
  },
  {
    id: 4,
...
export function SidebarContent({ homeData, userData }: SidebarContentProps) {
  return (
    <div className="p-6 2xl:p-12 space-y-8 2xl:space-y-12">
      ...
      <div className="bg-background dark:bg-zinc-900 rounded-[2.5rem] border border-border overflow-hidden shadow-sm">
        <ConsistencyGrid
