    ...
    <Container className="space-y-16 pb-20">
      ...
      <div className="bg-primary border border-primary/20 rounded-[3rem] p-10 overflow-hidden relative group">
        <div className="absolute top-0 right-0 p-12 opacity-10 group-hover:rotate-12 transition-transform duration-700">
          <SwordIcon weight="fill" className="size-48 text-primary-foreground" />
        </div>
        ...
        <div className="relative z-10 max-w-xl space-y-6">
          <div className="space-y-2">
            ...
            <h2 className="text-4xl font-anton italic text-primary-foreground uppercase leading-none">A Jornada do Campeão</h2>
          </div>
      ...
      <div className="space-y-12">
        <div className="px-2 flex items-center gap-3">
          <h2 className="text-base font-black text-foreground uppercase tracking-[0.2em] italic">Desafios Disponíveis</h2>
