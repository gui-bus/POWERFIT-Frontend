import { getWorkoutTemplates, applyWorkoutTemplate } from "@/lib/api/fetch-generated";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        ...
        {templates.length === 0 && (
          <div className="col-span-full py-20 text-center space-y-4 bg-card/50 border border-dashed border-border rounded-[3rem]">
            <p className="text-muted-foreground font-medium uppercase italic tracking-widest text-sm">Nenhum modelo disponível no momento.</p>
          </div>
        )}
      </div>
    </Container>
